export const toolRegistry = [
...

  {
    ...
    content: {
      ...
      faq: [
        ...
        {
          question:
            "Can I decode Base64 locally without sending data to a server?",
...

  {
    ...
    content: {
      ...
      faq: [
        ...
        {
          question:
            "Should I encode a full URL or only a query parameter value?",
      ...
      relatedTools: ["/url-parser", "/base64", "/regex-tester", "/json"],
    },
  },

  {
    ...
    content: {
      ...
      faq: [
        ...
        {
          question:
            "Can I use this tool to preview small UI snippets and email markup?",
...

  {
    ...
    description: "Convert YAML to formatted JSON directly in your browser.",
    ...
    content: {
      ...
      faq: [
        ...
        {
          question:
            "Can I use this for Docker Compose or Kubernetes YAML files?",
...

  {
    ...
    content: {
      ...
      faq: [
        ...
        {
          question:
            "Can I use this tool to format SQL copied from logs or ORMs?",
        ...
        {
          question:
            "Why does the tool warn about DROP, DELETE, TRUNCATE, or ALTER?",
        ...
        {
          question:
            "Can I use this SQL formatter in the browser without installing anything?",
      ...
      relatedTools: ["/csv-to-json", "/json", "/regex-tester", "/diff-checker"],
    },
  },
...

  {
    ...
    content: {
      ...
      faq: [
        ...
        {
          question:
            "Does this regex tester protect against catastrophic backtracking?",
...

  {
    ...
    content: {
      ...
      faq: [
        {
          question:
            "Does the URL need http:// or https:// to be parsed correctly?",
...

  {
    ...
    content: {
      ...
      relatedTools: ["/html-preview", "/markdown-preview", "/case-converter"],
    },
  },
];
